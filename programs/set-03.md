# Set 3: HTML + Docker + GitHub + DockerHub
...
4. Write a simple program in HTML, Build and run the Docker image and push the code to GITHUB and Docker Image to DockerHub.
...
**Aim:** Write a simple program in HTML, Build and run the Docker image and push the code to GITHUB and Docker Image to DockerHub.
