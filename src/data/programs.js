...
const programSpecs = [
  ["Java + Docker + GitHub + DockerHub", "Write a simple program in Java, build and run Docker image, push code to GitHub and image to DockerHub."],
  ["C + Docker + GitHub + DockerHub", "Write a simple program in C, build and run Docker image, push code to GitHub and image to DockerHub."],
  ["HTML + Docker + GitHub + DockerHub", "Write a simple program in HTML, build and run Docker image, push code to GitHub and image to DockerHub."],
  ["Python + Docker + GitHub + DockerHub", "Write a simple program in Python, build and run Docker image, push code to GitHub and image to DockerHub."],
  ["Node.js + Docker + GitHub + DockerHub", "Write a simple program in Node.js, build and run Docker image, push code to GitHub and image to DockerHub."],
  ["Flask Python + Docker + GitHub + DockerHub", "Write a simple Flask Python program, build and run Docker image, push code to GitHub and image to DockerHub."],
  ["C + GitHub + Jenkins Job", "Write a simple C program, push code to GitHub, create Jenkins job for execution."],
  ["Python calculator + GitHub + Jenkins Job", "Write Python add/sub/mul/div calculator, push code to GitHub, create Jenkins job."],
  ["Java reverse number + GitHub + Jenkins Job", "Write Java reverse number program, push code to GitHub, create Jenkins job."],
  ["Docker hello-world + Jenkins periodic shell job", "Run hello-world image and create Jenkins periodic shell job.", "Create a Jenkins job for executing shell commands using periodic build trigger."],
  ["HTML registration form + GitHub + Jenkins publish job", "Create HTML registration form, push to GitHub, create Jenkins job for publishing HTML page."],
  ["Jenkins pipeline using Jenkinsfile from SCM Git", "Create Jenkins pipeline job using Jenkinsfile from SCM Git."],
  ["Java and Python pattern display + Jenkins file parameterization", "Write Java and Python pattern programs and execute using Jenkins file parameterization."],
  ["Ubuntu Docker container named MyContainer + Jenkins pipeline", "Run Ubuntu image in Docker container named MyContainer and execute shell commands.", "Create a Jenkins pipeline job with 5 stages."],
  ["Python Docker image commands + Kubernetes nginx deployment", "Run Python Docker image and execute commands.", "Create nginx deployment in Kubernetes and run kubectl commands."],
  ["Node Docker image commands + Kubernetes Python deployment", "Run Node Docker image and execute commands.", "Create Python deployment in Kubernetes and run kubectl commands."],
  ["nginx Docker image commands + Kubernetes Mongo deployment", "Run nginx Docker image and execute commands.", "Create Mongo deployment in Kubernetes and run kubectl commands."],
  ["Containerized HTML registration form", "Develop containerized HTML registration form using Docker and push image to DockerHub and code to Git."],
  ["Docker Compose busybox ping task", "Using Docker Compose create busybox containers bbConA and bbConB and ping bbConB from bbConA."],
  ["Kubernetes nginx deployment using YAML manifest", "Create nginx deployment using Kubernetes YAML manifest files."],
  ["Kubernetes node deployment + Selenium website opener", "Create node deployment and run kubectl commands.", "Write JavaScript Selenium program to open Google or college website."],
  ["JavaScript login validation + Selenium", "Write JavaScript login validation application and test it using Selenium."],
  ["JavaScript Selenium exam result checker", "Write JavaScript program for checking exam results on https://matrusri.skolo.in/ and test using Selenium."],
  ["Web calculator app + Selenium testing", "Develop web calculator, write test cases for any operation, and test using Selenium."],
  ["Jenkins Java Git job remote trigger", "Create Jenkins job for executing Java program in Git using remote build trigger."],
  ["Jenkins Python calculator Git job SCM polling", "Create Jenkins job for Python calculator in Git using SCM polling trigger."],
  ["Java and Python calculator + Jenkins parameterization", "Write Java and Python calculator and execute using Jenkins file and variable parameterization."]
];
